...
class Account {
     ...
     */
    public
    Account ( OutputInterface out ) {
        mOut=out;
    }

    public
    Account ( OutputInterface mOut , String newName , int newNumber ) {
        this.mOut=mOut;
        name=newName;
        number=newNumber;
    }
    ...
    public
    Account ( OutputInterface mOut , String newName , int newnNumber , double initialBalance ) {
